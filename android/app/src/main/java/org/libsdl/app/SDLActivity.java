...
*/
    ...
    public static void commitOverlayText(String text) {
        SDLInputConnection.nativeCommitText(text, 1);
    }

    public static native void setCheat(int cheatId, boolean enabled);
    ...
    public static native void requestTouchOverlayFeatureNotice(int version);
